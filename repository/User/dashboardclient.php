  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <a class="nav-link "href="updateClient.php?retour=dashboardclient.php">Bonjour <?php echo $_SESSION["prenom"] ." ".$_SESSION["nom"]?></a>
        </li>
      </ul>
    </div>
  </div>
...
?>
<h2 align=center>je suis la page dashboard client</h2>
</body>
